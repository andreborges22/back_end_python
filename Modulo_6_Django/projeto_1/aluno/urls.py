...
urlpatterns = [
    ...
    #rota para o formulario de edicao do aluno. Quando o usuario clicar em editar: (enderecodosistema/aluno/editar/id)
    path('editar/<int:id>', views.editar, name="editar"),
    #rota interna para edicao de fato. Os dados do formulario de edeicao vao para persistencia em banco
